...
// Pasos do proceso de reasignacion
const PASOS = [
  { numero: '1', texto: 'Solicitude recibida polo xerente', activo: true },
  { numero: '2', texto: 'O xerente busca un novo horario', activo: false },
  { numero: '3', texto: 'Recibiras unha notificacion co novo horario', activo: false },
];

export default function SolicitudeReasignacionEnviadaScreen({ route, navigation }: any) {
      ...
      <ScrollView style={estilos.scroll} contentContainerStyle={estilos.scrollContido}>
        ...
        <View style={estilos.iconaCentral}>
          <View style={estilos.iconaCirculo}>
            <Ionicons name="swap-horizontal" size={48} color="#E8A317" />
          </View>
        </View>

        {/* Titulo */}
        <Text style={estilos.tituloConfirmacion}>Solicitude de reasignacion enviada</Text>

        {/* Estado actual da cita */}
        <Text style={estilos.tituloSeccion}>Cita a reasignar</Text>
        <View style={estilos.tarxetaEstado}>
          ...
          <View style={estilos.tarxetaEstadoContido}>
            ...
            <View style={estilos.badgePendente}>
              <Text style={estilos.badgePendenteTexto}>Pendente de reasignacion</Text>
            </View>
